/* Image Upload
 * This file is designed to fix the issue where the file name does not turn up.
 */  
this.ckan.module('metameta-image-upload', function($, _) {
  return {
    ...
    initialize: function () {
      ...
      this.button_remove = $('<a href="javascript:;" class="btn btn-danger btn-remove-url"><i class="icon-remove"></i></a>')
